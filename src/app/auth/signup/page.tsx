        ...
        <div className="w-full max-w-md p-8">
          <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-6 text-center">
            ...
            <p className="text-gray-400 mb-6">
              We've sent you a verification link to <span className="font-medium text-white">{email}</span>
            </p>
            <Link
              href="/auth/signin"
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center space-x-3 mb-8">
            ...
            <div className="flex items-baseline space-x-1">
              ...
              <span className="text-sm font-medium text-[#f7cc48] bg-[#f7cc48]/10 px-2 py-0.5 rounded-md">AI</span>
            </div>
          </Link>
          <h1 className="text-3xl font-bold text-white mb-2">Create Account</h1>
          <p className="text-gray-400">Start your Chinese learning journey today</p>
        </div>
