    ...
    <>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <Link href="/auth/signup" className="inline-flex items-center justify-center bg-[#f7cc48] hover:bg-[#f7cc48]/90 text-black font-medium text-lg px-8 py-4 rounded-md transition-colors">
                Try Free Flash Session
              </Link>
              <Link href="/demo" className="inline-flex items-center justify-center border border-[#30363d] text-[#7d8590] hover:bg-[#21262d] hover:text-white text-lg px-8 py-4 bg-transparent rounded-md transition-colors">
                Watch 90s Demo
              </Link>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-4">Scientifically Optimized Learning</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-[#21262d] border border-[#30363d] hover:border-[#f7cc48]/50 transition-all duration-300 cursor-pointer rounded-lg">
                <div className="p-8 text-center">
                  ...
                  <div className="text-sm text-[#7d8590]">Optimal attention span for maximum retention</div>
                </div>
              </div>
              ...
              <div className="bg-[#21262d] border border-[#30363d] hover:border-[#f7cc48]/50 transition-all duration-300 cursor-pointer rounded-lg">
                <div className="p-8 text-center">
                  ...
                  <div className="text-sm text-[#7d8590]">Miller's Law: optimal working memory capacity</div>
                </div>
              </div>
              ...
              <div className="bg-[#21262d] border border-[#30363d] hover:border-[#f7cc48]/50 transition-all duration-300 cursor-pointer rounded-lg">
                <div className="p-8 text-center">
                  ...
                  <div className="text-sm text-[#7d8590]">With spaced repetition vs 10% without</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-4">The Dual-Phase Flash System</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                <div className="border-l-4 border-[#f7cc48] pl-6">
                  <h3 className="text-2xl font-bold text-white mb-3">Phase 1: Visual Recognition</h3>
                ...
                <div className="border-l-4 border-[#f7cc48]/60 pl-6">
                  <h3 className="text-2xl font-bold text-white mb-3">Phase 2: Multi-Modal Integration</h3>
                  <p className="text-[#7d8590] mb-4">
                  ...
                  <div className="text-sm text-[#f7cc48]">Based on Mayer's Multimedia Learning Principles</div>
                </div>

                <div className="border-l-4 border-[#f7cc48]/40 pl-6">
                  <h3 className="text-2xl font-bold text-white mb-3">Immediate Quiz</h3>
                  <p className="text-[#7d8590] mb-4">
                    Testing effect: Active retrieval strengthens memory more than passive review. Immediate feedback
                    with audio reinforcement.
                  </p>
                  <div className="text-sm text-[#f7cc48]">Based on Roediger & Karpicke (2006): Testing Effect</div>
                </div>
              </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-4">Why Danbing AI Works</h2>
              <p className="text-xl text-[#7d8590] max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="p-6">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">SM-2 Spaced Repetition</h3>
              ...
              <div className="p-6">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">AI Auto-Enrichment</h3>
                <p className="text-[#7d8590]">
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            ...
            <Link href="/pricing" className="inline-flex items-center justify-center border border-[#30363d] text-[#7d8590] hover:bg-[#21262d] hover:text-white text-lg px-8 py-4 bg-transparent rounded-md transition-colors">
              View Pricing
            </Link>
          </div>
