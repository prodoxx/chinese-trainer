...
export default function PricingClient() {
  ...
  return (
    <>
      ...
      {/* Main Pricing Cards - Pro and Lifetime */}
      <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto mb-16">

        {/* Pro Plan */}
        <div className="bg-[#21262d] border-2 border-[#f7cc48] rounded-2xl relative transform hover:scale-105 transition-transform">
            ...
            <div className="text-center mb-8">
              ...
              <div className="mb-2">
                <div className="text-5xl font-bold text-white">
                  ${billingPeriod === 'annual' ? '12' : '15'}
                  <span className="text-2xl font-normal text-[#7d8590]">/mo</span>
                </div>
                {billingPeriod === 'annual' && (
                  <div className="text-sm text-[#7d8590] line-through">$15/mo</div>
                )}
              </div>
              <div className="text-[#f7cc48]">
                {billingPeriod === 'annual' ? 'Billed $144 annually' : 'Billed monthly'}
              </div>
      ...
      {/* Student Pro Plan - Special Offer for Students */}
      <div className="mt-16">
        <div className="bg-[#21262d] border border-[#30363d] rounded-2xl p-8 max-w-5xl mx-auto">
          <div className="text-center mb-8">
            <h3 className="text-3xl font-bold text-white mb-4">Student Pro Plan</h3>
            <div className="flex items-center justify-center gap-2 mb-4">
              <GraduationCap className="w-6 h-6 text-[#f7cc48]" />
              <span className="text-[#f7cc48] font-semibold">Special Academic Pricing</span>
            </div>
            <p className="text-lg text-[#7d8590] max-w-3xl mx-auto">
              We believe education should be accessible to everyone. That's why we offer students a 40% discount on our Pro plan. 
              We're committed to supporting your Chinese learning journey throughout your academic career with the same powerful tools 
              and AI features at a price that fits a student budget.
            </p>
          </div>

          <div className="bg-[#161b22] rounded-xl p-6 max-w-md mx-auto">
            <div className="text-center mb-6">
              <div className="mb-2">
                <div className="text-5xl font-bold text-white">
                  ${billingPeriod === 'annual' ? '7' : '9'}
                  <span className="text-2xl font-normal text-[#7d8590]">/mo</span>
                </div>
                {billingPeriod === 'annual' && (
              ...
              <div className="text-[#f7cc48]">
                {billingPeriod === 'annual' ? 'Billed $84 annually' : 'Billed monthly'}
              </div>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#7d8590]">Full access to all Pro features</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="text-white font-semibold">40% lifetime student discount</p>
                  <p className="text-xs text-[#7d8590]">Valid throughout your studies</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="text-white font-semibold">Same AI credits & features</p>
                  <p className="text-xs text-[#7d8590]">No limitations on learning</p>
                </div>
              </div>
            </div>
            ...
            <Link 
              ...
              className="block w-full bg-[#f7cc48] hover:bg-[#f7cc48]/90 text-black font-semibold py-3 px-6 rounded-lg transition-all text-center mb-3"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-[#7d8590]">
              <strong>How it works:</strong> Sign up with your academic email (.edu) to automatically receive the discount. 
              We'll verify your student status and apply the discount to your account immediately.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-16">
        <div className="bg-[#21262d] border border-[#30363d] rounded-2xl p-8 max-w-5xl mx-auto">
          <div className="text-center mb-8">
            ...
            <div className="text-3xl font-bold text-[#f7cc48] mb-2">Starting at $10/user/month</div>
