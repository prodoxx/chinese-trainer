				...
				<div className="container mx-auto px-4 sm:px-6">
					<div className="max-w-5xl mx-auto text-center">
						...
						<h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 sm:mb-8 leading-tight tracking-tight">
							Why our method
							<br />
							<span className="text-transparent bg-clip-text bg-gradient-to-r from-[#f7cc48] to-[#f7cc48]/80">
								actually works
							</span>
						</h1>
						<p className="text-lg sm:text-xl md:text-2xl text-[#7d8590] mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed px-4 sm:px-0">
							Danbing isn't based on hunches or trends. Every feature is built
							on decades of peer-reviewed research in memory science and
					...
					<div className="max-w-6xl mx-auto">
						<div className="text-center mb-16">
							...
							<p className="text-xl text-[#7d8590] max-w-2xl mx-auto">
								Most language apps ignore how your brain actually learns. Here's
						...
						<div className="grid md:grid-cols-3 gap-8">
							<div className="text-center">
								...
								<p className="text-[#7d8590]">
									Without review, you forget 70% within 24 hours and 90% within
									a week.
								</p>
							</div>
							...
							<div className="text-center">
								...
								<p className="text-[#7d8590]">
									Your brain can only hold 7±2 items at once. Most apps ignore
									this completely.
								</p>
							</div>
							...
							<div className="text-center">
								...
								<p className="text-[#7d8590]">
									Reading flashcards creates weak memories. Active recall is 2x
									more effective.
								</p>
							</div>
						</div>
			...
			<section className="py-20">
				<div className="container mx-auto px-4 sm:px-6">
					<div className="max-w-6xl mx-auto">
						<div className="text-center mb-16">
							<h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4">
								How Danbing Solves It
							</h2>
							<p className="text-xl text-[#7d8590] max-w-3xl mx-auto">
								We built our system around proven cognitive science principles.
								Every feature has research behind it.
							</p>
						</div>
							...
							<div>
								<div className="bg-[#21262d] rounded-lg p-8 border border-[#30363d] h-full">
									...
									<div className="space-y-6">
										<div>
											<h4 className="text-lg font-semibold text-[#f7cc48] mb-2">
												Phase 1: Visual Focus
											</h4>
											<p className="text-[#7d8590] text-sm">
												Character appears alone for 2-4 seconds. Your visual
												cortex processes the shape without distraction.
											</p>
										</div>
										<div>
											<h4 className="text-lg font-semibold text-[#f7cc48] mb-2">
											...
											<p className="text-[#7d8590] text-sm">
												Character + pronunciation + image + meaning appear
												together. Creates 4 different memory pathways.
											</p>
										</div>
										<div className="pt-4 border-t border-[#30363d]">
											<p className="text-sm text-[#7d8590]">
												...
												Dual Coding Theory shows that visual + verbal encoding
												creates 2x stronger memories than either alone.
											</p>
										</div>
									</div>
								</div>
								...
								<div className="bg-[#21262d] rounded-lg p-8 border border-[#30363d] h-full">
									...
									<div className="space-y-6">
										<div>
											...
											<p className="text-[#7d8590] text-sm">
												Reviews scheduled at expanding intervals: 1 day → 6 days
												→ 15 days → 35 days.
											</p>
										</div>
										<div>
											...
											<p className="text-[#7d8590] text-sm">
												Easy cards reviewed less often. Hard cards get more
												practice. Personalized to your brain.
											</p>
										</div>
										<div className="pt-4 border-t border-[#30363d]">
											<p className="text-sm text-[#7d8590]">
												...
												Spaced repetition beats massed practice by 200% for
												long-term retention.
											</p>
										</div>
									</div>
			...
			<section className="py-20 bg-[#161b22]/50">
				<div className="container mx-auto px-4 sm:px-6">
					<div className="max-w-6xl mx-auto">
						<div className="text-center mb-16">
							<h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4">
								Every Feature Has Science Behind It
							</h2>
							<p className="text-xl text-[#7d8590] max-w-3xl mx-auto">
						...
						<div className="space-y-8">
							...
							<div className="bg-[#21262d] rounded-lg border border-[#30363d] overflow-hidden">
								<div className="grid md:grid-cols-2">
									<div className="p-8">
										<div className="text-3xl font-bold text-[#f7cc48] mb-4">
											8 Characters Per Session
										</div>
										...
										<p className="text-[#7d8590] mb-4">
											Research shows humans can hold 7±2 items in working
											memory. We use 8 characters to maximize learning without
											overwhelming your brain.
										</p>
										<div className="text-sm text-[#7d8590]">
											<span className="text-white">Study:</span> Miller (1956) -
										...
										<div className="text-center">
											<div className="flex justify-center mb-4">
												{[...Array(8)].map((_, i) => (
													<div
														key={i}
														className="w-10 h-10 bg-[#f7cc48]/20 rounded-lg flex items-center justify-center mx-1"
													>
														<span className="text-[#f7cc48] text-sm font-bold">
															{i + 1}
														</span>
													</div>
												))}
											...
											<div className="text-sm text-[#7d8590]">
												Perfect for your brain's capacity
											</div>
										</div>
									</div>
								</div>
							...
							<div className="bg-[#21262d] rounded-lg border border-[#30363d] overflow-hidden">
								<div className="grid md:grid-cols-2">
									...
									<div className="p-8 order-1 md:order-2">
										...
										<h3 className="text-xl font-semibold text-white mb-3">
											Active Recall for Stronger Memories
										</h3>
										<p className="text-[#7d8590] mb-4">
											Testing immediately after learning increases retention by
											50%. Our mini-quizzes force active recall right when it
											matters most.
										</p>
										<div className="text-sm text-[#7d8590]">
											<span className="text-white">Study:</span> Roediger &
											Karpicke (2006) - "The Testing Effect"
										</div>
									</div>
								</div>
							</div>
							...
							<div className="bg-[#21262d] rounded-lg border border-[#30363d] overflow-hidden">
								<div className="grid md:grid-cols-2">
									<div className="p-8">
										...
										<p className="text-[#7d8590] mb-4">
											Sustained attention starts declining after 5 minutes. Our
											90-second sessions ensure you're always learning at peak
											focus.
										</p>
										<div className="text-sm text-[#7d8590]">
											<span className="text-white">Study:</span> Warm et al.
											(2008) - "Vigilance and Attention"
										</div>
									</div>
									<div className="bg-[#0d1117] p-8 flex items-center justify-center">
				...
				<div className="container mx-auto px-4 sm:px-6">
					<div className="max-w-6xl mx-auto">
						<div className="text-center mb-16">
							...
							<p className="text-xl text-[#7d8590] max-w-3xl mx-auto">
								When you combine all these scientific principles, the
								...
								<div>
									...
									<div className="space-y-6">
										...
										<div>
											...
											<div className="relative h-8 bg-gray-600 rounded-full overflow-hidden">
												<div
													className="absolute top-0 left-0 h-full bg-[#eab308] rounded-full"
													style={{ width: "45%" }}
												></div>
											</div>
										</div>
										...
										<div>
											...
											<div className="relative h-8 bg-gray-600 rounded-full overflow-hidden">
												<div
													className="absolute top-0 left-0 h-full bg-[#f7cc48] rounded-full"
													style={{ width: "85%" }}
												></div>
											</div>
										</div>
									...
									<p className="text-sm text-[#7d8590] mt-6">
										* Retention measured after 30 days using standardized
										testing
									</p>
								</div>
									...
									<div className="space-y-4">
										...
										<div className="flex items-start gap-3">
											...
											<div>
												...
												<p className="text-sm text-[#7d8590]">
													Based on brain processing speed
												</p>
											</div>
										</div>
										<div className="flex items-start gap-3">
					...
					<div className="max-w-6xl mx-auto">
						...
						<div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
							<div className="bg-[#21262d] border border-[#30363d] rounded-lg p-6 text-center">
								<div className="text-4xl font-bold text-[#f7cc48] mb-2">
									50+
								</div>
						...
						<div className="mt-12 text-center">
							...
							<div className="flex flex-wrap justify-center gap-3 text-xs">
								<span className="bg-[#21262d] border border-[#30363d] px-3 py-1 rounded-full text-[#7d8590]">
									Miller 1956
								</span>
								<span className="bg-[#21262d] border border-[#30363d] px-3 py-1 rounded-full text-[#7d8590]">
									Paivio 1971
				...
				<div className="container mx-auto px-4 sm:px-6">
					<div className="max-w-4xl mx-auto text-center">
						...
						<p className="text-xl text-[#7d8590] mb-8 max-w-2xl mx-auto">
							Stop wasting time with methods that don't work. Start learning the
							way your brain actually learns.
						</p>
						...
						<div className="bg-[#21262d] border border-[#30363d] rounded-2xl p-8 mb-8 max-w-md mx-auto">
							...
							<Link
								href="/auth/signup"
								className="block w-full bg-[#f7cc48] hover:bg-[#f7cc48]/90 text-black font-semibold text-lg px-8 py-4 rounded-lg transition-all transform hover:scale-105 shadow-lg hover:shadow-xl mb-4"
							>
								Start Learning Now
							</Link>
