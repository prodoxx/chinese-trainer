...
Format your response as JSON:
{
  ...
  "imagePrompt": "Simple illustration showing [action/expression] that represents [meaning]. If showing people, use diverse representation including East Asian, Hispanic, White, or Black individuals. Avoid South Asian/Indian representation. Cartoon or minimalist style preferred."
}
...
Important: For emotional or state words, focus on visual expressions or body language that represents the feeling.`;
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a Chinese language expert helping create educational flashcards. Always provide accurate, concise interpretations suitable for language learners.',
        },
        {
          role: 'user',
          content: prompt,
