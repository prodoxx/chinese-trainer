...
async function createPlaceholderFiles() {
  ...
  for (const char of DEMO_CHARACTERS) {
    ...
    // Create image placeholder (1x1 JPEG)
    const imagePath = join(charDir, 'image.jpg')
    // Minimal 1x1 JPEG placeholder (note: real images are generated by generate-demo-media.ts)
  ...
  console.log('   - demo-deck/demo-大/audio.mp3 & image.jpg')
  console.log('   - demo-deck/demo-小/audio.mp3 & image.jpg') 
  console.log('   - demo-deck/demo-人/audio.mp3 & image.jpg')
